...
#              "of ", str(window_size) + "." )        
    ...
    def get_train_and_test_data(self):
        ...
        X2 = []
        x3 = []
        for i in range(0, len(WESAD_data.FEATURES['a_mean'])):
            X1.append([WESAD_data.FEATURES['a_mean'][i], WESAD_data.FEATURES['a_std'][i],\
                       WESAD_data.FEATURES['a_maxx'][i], WESAD_data.FEATURES['a_maxy'][i],\
                       WESAD_data.FEATURES['a_maxz'][i], WESAD_data.FEATURES['e_max'][i],\
                       WESAD_data.FEATURES['e_min'][i],  WESAD_data.FEATURES['e_mean'][i],\
                       WESAD_data.FEATURES['e_range'][i],WESAD_data.FEATURES['e_std'][i],\
                       WESAD_data.FEATURES['t_max'][i],  WESAD_data.FEATURES['t_min'][i],\
                       WESAD_data.FEATURES['t_mean'][i], WESAD_data.FEATURES['t_range'][i],\
                       WESAD_data.FEATURES['t_std'][i]])
        #print(np.shape(X1))
        
        for i in range(0,  len(WESAD_data.STRESS_FEATURES['a_mean'])):
            X2.append([WESAD_data.STRESS_FEATURES['a_mean'][i], WESAD_data.STRESS_FEATURES['a_std'][i],\
                       WESAD_data.STRESS_FEATURES['a_maxx'][i], WESAD_data.STRESS_FEATURES['a_maxy'][i],\
                       WESAD_data.STRESS_FEATURES['a_maxz'][i], WESAD_data.STRESS_FEATURES['e_max'][i],\
                       WESAD_data.STRESS_FEATURES['e_min'][i], WESAD_data.STRESS_FEATURES['e_mean'][i],\
                       WESAD_data.STRESS_FEATURES['e_range'][i], WESAD_data.STRESS_FEATURES['e_std'][i],\
                       WESAD_data.STRESS_FEATURES['t_max'][i], WESAD_data.STRESS_FEATURES['t_min'][i],\
                       WESAD_data.STRESS_FEATURES['t_mean'][i], WESAD_data.STRESS_FEATURES['t_range'][i],\
                       WESAD_data.STRESS_FEATURES['t_std'][i]])                
        #print(np.shape(X2))
        
        for i in range(0,  len(WESAD_data.AMUSE_FEATURES['a_mean'])):
            X3.append([WESAD_data.AMUSE_FEATURES['a_mean'][i], WESAD_data.AMUSE_FEATURES['a_std'][i],\
                       WESAD_data.AMUSE_FEATURES['a_maxx'][i], WESAD_data.AMUSE_FEATURES['a_maxy'][i],\
                       WESAD_data.AMUSE_FEATURES['a_maxz'][i], WESAD_data.AMUSE_FEATURES['e_max'][i],\
                       WESAD_data.AMUSE_FEATURES['e_min'][i], WESAD_data.AMUSE_FEATURES['e_mean'][i],\
                       WESAD_data.AMUSE_FEATURES['e_range'][i], WESAD_data.AMUSE_FEATURES['e_std'][i],\
                       WESAD_data.AMUSE_FEATURES['t_max'][i], WESAD_data.AMUSE_FEATURES['t_min'][i],\
                       WESAD_data.AMUSE_FEATURES['t_mean'][i], WESAD_data.AMUSE_FEATURES['t_range'][i],\
                       WESAD_data.AMUSE_FEATURES['t_std'][i]])  
        
        # initialize zero for base, 1 for stress and 2 for amuse
        y1 = [0] * len(X1)
        y2 = [1] * len(X2)
        y3 = [2] * len(X3)
    ...
    def load_model(self, file_name=last_saved):
        ...
        file = (os.path.join(WESAD_data.MODELS_DIR, file_name))
    ...
    def save_model(self, model):
        ...
        WESAD_data.last_saved = str("model-" + \
                                     str(now.replace(microsecond=0)) +\
                                     ".h5").replace(" ", "").replace(":", "_")
        model.save(os.path.join(WESAD_data.MODELS_DIR, WESAD_data.last_saved))
        print("Saved model to disc:",\
              WESAD_data.last_saved)
